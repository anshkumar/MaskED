...
def reload_model_weights(
    model, sub_release, model_name, pretrained="imagenet", mismatch_class=None, force_reload_mismatch=False, request_resolution=-1, method=None
):
    ...
    file_hash = PRETRAINED_DICT.get(model_name, {}).get(pretrained, None)
    ...
    url = pre_url.format(sub_release, model_name, pretrained)
